...
CEffect_IceBoom::CEffect_IceBoom()
{
...
CEffect_IceBoom::CEffect_IceBoom(const CEffect_IceBoom& eft)
{
}
...
void CEffect_IceBoom::Initialize()
{
	...
	m_effectSprite->Initialize(L"res/effect/eadric_ice_boom.png", 0.0f, 0.0f, 1.0f, 1.0f, 1.0f, 1.0f);
	...
	m_sound = new CSound();
	m_sound->Initialize("res/sound/se/iceflower.wav");
	m_sound->Loop(false);
}

void CEffect_IceBoom::Shutdown()
{
...
void CEffect_IceBoom::SetDamage(int num, int totalDamage)
{
	m_attackNum = num;
	m_damage = static_cast<int>(totalDamage/num);
}

bool CEffect_IceBoom::GetAlive()
{
	return !m_effectTimer->GetTimer();
}

void CEffect_IceBoom::Update()
{
