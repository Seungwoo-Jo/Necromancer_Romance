...
#include "CMonster_God.h"

CMonster_God::CMonster_God()
{
}
...
void CMonster_God::Initialize()
{
	...
	setIdNum(1000);
	setStat(5000, 500, 35, 10, 0);
	setArmorType(ARMOR::SPIRIT);
...
void CMonster_God::Update()
{

}

int CMonster_God::UseSkill(int num)
{
	if(num == 0) {
		return skill_1();
	}
