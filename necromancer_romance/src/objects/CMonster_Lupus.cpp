...
#include "CMonster_Lupus.h"

CMonster_Lupus::CMonster_Lupus()
{
}
...
void CMonster_Lupus::Update()
{

}

int CMonster_Lupus::UseSkill(int num)
{
	if(num == 0) {
		return skill_1();
	}
