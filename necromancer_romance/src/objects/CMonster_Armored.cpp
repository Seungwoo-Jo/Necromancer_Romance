...
#include "CMonster_Armored.h"

CMonster_Armored::CMonster_Armored()
{
}
...
void CMonster_Armored::Initialize()
{
	CBitmap* tempBitmap = new CBitmap();
	CTextureShader* tempShader = new CTextureShader();
	CTextureShader* hitShader = new CTextureShader();
	tempBitmap->Initialize(L"res/monsters/monster_armored.png", 0.0f, 0.0f, 1.0f, 1.0f, 1.0f, 1.0f);
...
void CMonster_Armored::Update()
{

}

int CMonster_Armored::UseSkill(int num)
{
	if(num == 0) {
		return skill_1();
	}
