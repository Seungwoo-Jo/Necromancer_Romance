...
#include "CMonster_Succubus.h"

CMonster_Succubus::CMonster_Succubus()
{
}
...
void CMonster_Succubus::Initialize()
{
	CBitmap* tempBitmap = new CBitmap();
	CTextureShader* tempShader = new CTextureShader();
	CTextureShader* hitShader = new CTextureShader();
	tempBitmap->Initialize(L"res/monsters/monster_succubus.png", 0.0f, 0.0f, 1.0f, 1.0f, 1.0f, 1.0f);
...
void CMonster_Succubus::Update()
{

}

int CMonster_Succubus::UseSkill(int num)
{
	if(num == 0) {
		return skill_1();
	}
