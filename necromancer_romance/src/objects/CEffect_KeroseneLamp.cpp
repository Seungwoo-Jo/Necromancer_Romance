...
CEffect_KeroseneLamp::CEffect_KeroseneLamp()
{
...
CEffect_KeroseneLamp::CEffect_KeroseneLamp(const CEffect_KeroseneLamp& eft)
{
}
...
void CEffect_KeroseneLamp::Initialize()
{
	...
	m_effectSprite->Initialize(L"res/effect/nero_kerosene_lamp.png", 0.0f, 0.0f, 1.0f, 1.0f, 1.0f, 1.0f);
	...
	m_sound = new CSound();
	m_sound->Initialize("res/sound/se/lampfire.wav");
	m_sound->Loop(false);
}

void CEffect_KeroseneLamp::Shutdown()
{
...
void CEffect_KeroseneLamp::Reset()
{
	m_attackNum = 1;
...
void CEffect_KeroseneLamp::SetDamage(int num, int totalDamage)
{
	m_attackNum = num;
	m_damage = static_cast<int>(totalDamage/num);
}

bool CEffect_KeroseneLamp::GetAlive()
{
	return !m_effectTimer->GetTimer();
}

void CEffect_KeroseneLamp::Update()
{
...
void CEffect_KeroseneLamp::Render()
{
